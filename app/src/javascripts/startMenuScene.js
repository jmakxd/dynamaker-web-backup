...
//		//
		...
		if(typeof FileReader == 'undefined'){
			...
			ctx.textAlign = "center";
			ctx.fillStyle = "#0FF";
			ctx.fillText("We recommend .ogg/.wav file to make for smaller offset error.", windowWidth * 0.5, windowHeight * 0.90);
			...
			ctx.fillText("Ported by Jmak and TLChicken", windowWidth * 0.5, windowHeight * 0.79);
